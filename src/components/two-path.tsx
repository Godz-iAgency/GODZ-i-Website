...
export function TwoPath() {
  return (
    <section id="two-path" className="relative section-spacing overflow-hidden bg-surface">
      {/* Top divider */}
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-10">
        <div className="text-center mb-20 md:mb-24">
          ...
          <Reveal delay={0.1}>
            <p className="text-zinc-500 mt-5 text-base md:text-lg max-w-md mx-auto">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-5 mb-10">
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-[11px] font-bold tracking-[0.14em] uppercase text-zinc-500 group-hover:text-zinc-400 transition-colors">
                        {badge}
                      </span>
                    </div>
                  </div>
                  ...
                  <p className="text-[15px] md:text-base text-zinc-500 leading-relaxed mb-12 max-w-[44ch]">
                    {description}
                  </p>
